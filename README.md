...
const aboutMe = {
  ...
  of my workflow. I leverage these skills to streamline repetitive tasks, both complex and mundane. Whether it's a 
  CLI script to fill payroll hours or a comprehensive Cypress framework to test an app used by 100,000+ users, it will
  be automated. While my automation work tackles daily needs and other requirements, I polish scripts and code before
