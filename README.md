...
const aboutMe = {
  ...
  about: `👨🏽‍💻 I am a Computer Science graduate and IT professional who has dedicated the last few years to building
  ...
  Whether it's a CLI script to fill payroll hours or a comprehensive Cypress framework to test an app used by 100,000+
  users, it will be automated. While my automation work tackles daily needs and other requirements, I polish scripts
  and code before sharing on GitHub by improving capabilities, documentation, and structure. That way you get more to
  work with and can better contribute to my projects.`,
